...
class UserRepository {
  async createUser({ email, password, passwordAlgorithm = 'pbkdf2_sha512', status = 'active' }, client = null) {
    ...
    const sql = `
      INSERT INTO users (id, email, email_normalized, password_hash, password_algorithm, status)
      VALUES ($1, $2, $3, $4, $5, $6)
      RETURNING *;
    `;
    const params = [id, email.trim(), normalized, passwordHash, passwordAlgorithm, status];
